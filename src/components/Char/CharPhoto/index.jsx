...
const CharPhoto = ({
  ...
  const dispatchFavouriteChar = () => {
    if (charFavourite) {
      dispatch(removeCharToFavourite(charId));
      setCharFavourite(false);
    } else {
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <button className={styles.favorite} onClick={dispatchFavouriteChar}>
          <svg
            height="511pt"
